...
myint getSetupFromFile(string filename,
                       myint *numThreads,
                       myint *dimensionOld,
                       myint *dimensionNew,
                       myint *maxTime,
                       myint *maxCost,
                       myint *n,
                       myint *boundaryVertCost,
                       myint *boundaryChoice,
                       myint *debuggingMode,
                       myint *cpuForce) {
...
myint createBigGraph(Graph **pMyGraph,
                     myint d,
                     myint n,
                     myint maxTime,
                     myint maxCost,
